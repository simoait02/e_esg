          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Token",
                  style: GoogleFonts.poppins(fontSize: 16, color: CardiInf.isDarkMode.value ? Colors.white : Colors.black),
                ),
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: tokenFocusNode.hasFocus
                          ...
                          : (CardiInf.isDarkMode.value ? CupertinoColors.white.withOpacity(0.5) : const Color(0xFFEAEBF6)),
                      width: 2.0,
                    ),
