...
import 'package:e_esg/pages/espaceInfermier/home/Profile/bottomModalsheet.dart';
            ...
            children: [
              ...
              Container(
                ...
                child: editable ? Image.asset("assets/images/$image.png",
                  color: CardiInf.isDarkMode.value ? CupertinoColors.white.withOpacity(0.5) : CupertinoColors.black.withOpacity(0.5),) : Container(),
              ),
            ],
          ),
        ),
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
                ...
                onTap: () {
                  showBarModalBottomSheet(
                    ...
                    return Bottommodalsheet(
                      height: height * 0.5,
                      isDarkMode: CardiInf.isDarkMode.value,
                      width: width,
                      parametre: "Nom",
            ...
            SizedBox(height: height * 0.02,),
            Divider(
              color: CardiInf.isDarkMode.value ? Colors.white.withOpacity(0.2) : Colors.black.withOpacity(0.2),
              thickness: 1,
            ),
            SizedBox(height: height * 0.02,),
            GestureDetector(
