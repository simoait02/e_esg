            ...
            actions: <Widget>[
              IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    CupertinoPageRoute(builder: (context) => const SettingsPro()),
                  );
                },
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Row(
                        children: [
                          CircleAvatar(
                            radius: 40,
                            backgroundColor: CardiInf.isDarkMode.value ? Colors.white24 : Colors.black26,
                            child: Icon(Icons.person, color: CardiInf.isDarkMode.value ? Colors.white : Colors.black, size: 60),
                          ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: CardiInf.isDarkMode.value ? Colors.white24 : const Color(0xfffafffa),
                      borderRadius: BorderRadius.circular(15),
                      border: Border.all(color: CardiInf.isDarkMode.value ? Colors.white.withOpacity(0.5) : Colors.black.withOpacity(0.5)),
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: GoogleFonts.poppins(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w400,
                                  color: CardiInf.isDarkMode.value ? Colors.white38 : Colors.black38,
                                ),
                              ),
                            )
                          ],
