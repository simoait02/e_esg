...
import 'package:e_esg/pages/espaceInfermier/home/teleExpertise/plus_infos.dart';
    ...
    return Container(
      ...
      child: Text(
        ...
        style: GoogleFonts.poppins(
          textStyle: TextStyle(
            color: CardiInf.isDarkMode.value ? CupertinoColors.white : CupertinoColors.black,
                ...
                typeNoti == 0
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: CardiInf.isDarkMode.value ? const Color(0xe5212125) : const Color(0xfffbfbfd),
                      border: Border.all(color: CardiInf.isDarkMode.value ? Colors.white24 : Colors.black26),
                    ),
                    child: Column(
                      children: [
                        const ListTile(
