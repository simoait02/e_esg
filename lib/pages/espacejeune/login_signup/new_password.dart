...
class NewPassword extends StatefulWidget {
  ...
  const NewPassword({super.key, required this.onBackTapped, required this.onValidTapped});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Token",
                  style: GoogleFonts.poppins(fontSize: 16, color: CardiJeune.isDarkMode.value ? Colors.white : Colors.black),
                ),
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: tokenFocusNode.hasFocus
                          ...
                          : (CardiJeune.isDarkMode.value ? CupertinoColors.white.withOpacity(0.5) : const Color(0xFFEAEBF6)),
                      width: 2.0,
                    ),
